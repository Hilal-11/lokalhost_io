...
export default function FeaturesBento() {
  return (
    <div className='w-full h-full'>
        <div className='w-full mx-auto pt-8 pb-8 lg:pt-20 relative lg:pb-20 px-2'>
            <motion.h1
            initial={{ opacity: 0, y: 110 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, }}
            className='z-20 text-center font-sans font-bold text-2xl lg:text-4xl text-neutral-800 dark:text-neutral-200 pb-3 tracking-tight'>
              All Essential Features in{" "}
              <span className="font-mono text-neutral-500 dark:text-neutral-500">one place</span>
            </motion.h1>
            <motion.p
            initial={{ opacity: 0, y: 100 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, }}
            className='px-8 lg:px-2 z-20 text-center text-sm lg:text-[17px] font-sans font-medium text-neutral-500 dark:text-neutral-400 lg:w-1/2 mx-auto leading-relaxed'>
        ...
        <div className="relative h-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-0 lg:gap-0 border-b border-dashed px-px">
            ...
            <div className="w-full lg:col-span-2 relative h-full lg:h-[340px] border-r border-dashed border-t flex flex-wrap justify-start mask-x-from-80% mask-x-to-100% pb-5">
              <div className="w-full lg:w-[70%] lg:px-4 pt-8 space-y-6">
                <div className='space-y-2 pl-5 pr-5 lg:pr-10'>
                  <h1 className='text-left font-sans text-xl lg:text-2xl font-bold text-neutral-800 dark:text-neutral-200'>Seemless integration and Opinionated, Yet Fully Customizable</h1>
                  <p className='text-left font-sans font-medium text-[15px] text-neutral-600 dark:text-neutral-400'>Experience seamless integration with opinionated yet fully customizable components, designed to accelerate development across the entire React ecosystem, including React.js, Next.js, and more. Start fast with strong defaults and scale confidently as your product grows.</p>
                </div>

              </div>
              <div className='hidden lg:flex md:flex w-full lg:w-[30%] items-center justify-center relative top-4 left-4 bottom-0'>
                <TechEcosystemOrbit />  
              </div>
            </div>

            <div className="relative h-[340px] w-full border border-dashed overflow-hidden">
              <div className='space-y-4 pt-6 px-5 lg:px-10'>
                  <h1 className='text-left font-sans text-xl lg:text-2xl font-bold text-neutral-800 dark:text-neutral-200'>Copy–Paste or CLI Install</h1>
                  <p className='text-left font-sans font-medium text-sm text-neutral-600 dark:text-neutral-400 lg:px-2'>Install components your way — copy and paste directly into your codebase or use the CLI for faster setup. No lock-in, no magic, just clean code that becomes part of your project.</p>
                </div>
                <div className='lg:px-10 px-5 pt-4 '>
                  <TerminalDemo />  
                </div>
            </div>
            <div className="relative overflow-hidden h-[340px] w-full border-r border-dashed border-t pt-5 px-5 lg:px-6">
                <div>
                  <AnimatedBeamMultipleOutputDemo />
                </div>
                <div className='space-y-2 pl-5 pr-5 lg:pr-10 absolute bottom-2'>
                  ...
                  <p className='text-left font-sans font-medium text-sm text-neutral-600 dark:text-neutral-400'>Everything on lokalhost.io is built with intent — focused on solving real product needs, not adding unnecessary noise.</p>
                </div>
            </div>

            <div className="relative overflow-hidden h-[340px] w-full border-r border-dashed border-t">
                <div className='space-y-4 pt-4 px-5 lg:px-10'>
                  <h1 className='text-left font-sans text-xl lg:text-2xl font-bold text-neutral-800 dark:text-neutral-200'>Businesses and Startup-Ready Templates</h1>
                  <p className='text-left font-sans font-medium text-sm text-neutral-600 dark:text-neutral-400 lg:px-2'>Templates built for businesses and startups, designed with real-world layouts, functional flows, and production use in mind.</p>
                </div>
            ...
            <div className="relative overflow-hidden h-[340px] w-full border-r border-dashed border-t">
                <div className='space-y-4 pt-10 lg:pt-6 px-5 lg:px-8'>
                  <h1 className='text-left font-sans text-xl lg:text-2xl font-bold text-neutral-800 dark:text-neutral-200'>Custom Work & Dedicated Support</h1>
                  <p className='text-left font-sans font-medium text-sm text-neutral-600 dark:text-neutral-400 lg:px-2'>Need something custom or wana build something The lokalhost.io team is available to make client work and help our uers, whether you want to build SASS, Website for your business or complete cross-platform mobile application for you business, we're here to make it possible with complete Deployment process and unlimitd changes.</p>
                </div>
                  <div className='w-full flex items-end justify-end pr-8 gap-2'>
                    <button className='text-xs flex gap-1 items-center justify-center border-t-[2px] border-l-[2px] border-r-[2px] border-neutral-950 dark:border-neutral-800 cursor-pointer font-sans font-medium px-2 py-1 rounded-md bg-gradient-to-t from-[#262626] to-[#525252] text-neutral-200 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]'>Talk to us.</button>
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[250px] w-full items-center justify-center p-10",
        className
      )}
      ref={containerRef}
    >
