...
// bg-black mask-[radial-gradient(ellipse_50%_50%_at_50%_50%,_#000_70%,_transparent_100%)] w-96 h-96

      // <div className="absolute inset-0 -z-10 h-full w-full bg-white blur-[2px] [background:radial-gradient(110%_110%_at_50%_50%,#fff_20%,#B3e_100%)] flex justify-center items-center ">
      //   <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] -z-20"></div>
      // </div>
...
export const BACKGROUND_OPTIONS = [
  ...
  {
    name: 'BgPeal Type With Grids',
    component: <BgPealTypeWithGrid1 />,
    
    theme: 'peal',
  },
  {
    name: 'BgPeal Type With Grids 2',
    component: <BgPealTypeWithGrid2 />,
    theme: 'peal',
  },
] as const;
