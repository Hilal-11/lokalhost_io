...
const  Signup = () => {
  ...
  return (
    ...
    <div className="dark:hidden absolute top-0 z-[-2] h-auto w-full flex rotate-180 transform bg-white bg-[radial-gradient(60%_120%_at_50%_50%,hsla(0,0%,100%,0)_0,rgba(252,205,238,.5)_100%)]"></div>
      ...
      shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] px-5 py-4 flex justify-center items-center md:rounded-xl lg:rounded-xl">
        <form>
            ...
            <p className="font-sans font-medium text-sm pl-1.5 text-neutral-700 dark:text-neutral-300 pb-8 py-1">Login to your account to get start building?</p>
            <div className="mt-0">
            ...
            <div className="mt-4 text-center text-sm 0 mx-auto">
                <p >Do you have an account <Link href="#" className="font-bold text-neutral-500 pl-1 underline"> Signup</Link></p>
            </div>
